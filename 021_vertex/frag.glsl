...
// 	}
    ...
    res = opU( res,
    mix(
    vec2( sdSphere(       pos-vec3( 1.0,0.25, 0.0), 0.25 ), 3.0 ),
    vec2( sdBox(       pos-vec3( 1.0,0.25, 0.0), vec3(0.25,0.25,0.25) ), 3.0 ),
    sin(iTime) * 0.5 + 0.5
    )
    );
...
void main()
{
    ...
    // gl_FragColor = vec4( mix(red, blue, tot.r), 1.0 );
